 ...
 * 
 * All sorting methods and helpers were all taken from the textbook website
...
public class ComplexityLaboratory {
    ...
    /*
     * Creates an array for each method of sorting; resets counter to 0;
     * increments the index of N and the index of counter (f(N)) accordingly
     * example:   0     1    2     3     4     5      6     7                 40     41
                | 0 | f(0) | 5 | f(5) | 10 | f(10) | 15 | f(15) |    ......| 100 | f(100) |
     */
