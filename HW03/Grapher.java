...
public class Grapher {
   ...
   public static void main(String [] args) {
      ...
      Grapher G = new Grapher("Comparison of Average Case Sort for Five Algorithms");
      
      // the following is a typical curve, pairs of numbers x, f(x)....
      // can also just do integers
      
      G.drawCurve(D, "Selection Sort");
      G.drawCurve(C, "Insertion Sort");
      G.drawCurve(F, "Shell Sort");
      G.drawCurve(E, "Merge Sort");
      G.drawCurve(A, "Quick Sort");
