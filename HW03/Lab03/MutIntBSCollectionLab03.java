 ...
 * Editor: Calvin Yung (cyunt20@bu.edu)
...
public class MutIntBSCollectionLab03 {
    ...
    public boolean member(int key) {
        ...
        return (loc < A.length && A[loc] == key);   // see if it is there 
    ...
    // Prints out the values in the array before the '|'
    
    public String toString() {
        System.out.print("A: [ ");
        for (int i = 0; i < A.length; ++i) {
            if (i == next) System.out.print("| "); 
    ...
    public static void main(String [] args) {
        ...
        //shows values in the array and the value of next
        System.out.println();
        System.out.println(C.toString());
        System.out.println();
