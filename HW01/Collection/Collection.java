 ...
 * Class: CS 112, HW01
 * Purpose: Contains methods that allow the user to insert and delete integers into an array.
 *          Also expands and shrinks the size of the array depending on the number of
 *          inserted integers that are in the array.
 */
